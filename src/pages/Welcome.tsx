...
import { FastParkingLogo, QrCodeIcon } from '@/components/Icons';
  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-screen p-4 text-center animate-fade-in">
      ...
      <main className="w-full max-w-xs">
        <Link
          to="/save-session"
          className="flex items-center justify-center w-full bg-fp-blue text-white font-bold py-4 px-4 rounded-lg shadow-lg hover:bg-opacity-90 transition-transform transform hover:scale-105"
